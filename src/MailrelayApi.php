...
class MailrelayApi
{
    ...
    public function mailrelay_api_request($method, $url, $args = [], $mailrelay_data = null)
    {
    ...
    {
        $response = $this->mailrelay_api_request('GET', 'groups', [], null);
    ...
    {
        $response = $this->mailrelay_api_request('GET', 'ping', [], $mailrelay_data);
        if ($response['error']) {
            return false;
        }
